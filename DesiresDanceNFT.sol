...
contract DesiresDanceNFT is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Pausable, Ownable, ERC2981 {
    ...
    constructor(address initialOwner)
        ERC721("Desire's Dance NFT", "DDNFT")
    ...
    function mint(address to) external onlyOwner payable {
        ...
        _setTokenURI(tokenId, "ipfs://QmTG3rpe3YvUZTUjb2fp7TrEzL5pF7QJGke8WHZzdfun1k/2/");
        _setTokenRoyalty(tokenId, initialOwnerR, 100);

        musicTracks[tokenId] = MusicTrack("Desire's Dance", "Aria Harmony");
