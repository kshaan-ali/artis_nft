...
contract UnstoppableNFT is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Pausable, Ownable, ERC2981 {
    ...
    function mint(address to) external onlyOwner payable {
        ...
        _setTokenURI(tokenId, "ipfs://QmTG3rpe3YvUZTUjb2fp7TrEzL5pF7QJGke8WHZzdfun1k/7/");
        _setTokenRoyalty(tokenId, initialOwnerR, 100);

         musicTracks[tokenId] = MusicTrack("Unstoppable", "Aria Harmony");
