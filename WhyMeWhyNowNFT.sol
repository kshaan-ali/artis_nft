...
contract WhyMeWhyNowNFT is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Pausable, Ownable, ERC2981 {
    ...
    constructor(address initialOwner)
        ERC721("Why me, Why now? NFT", "WMWNFT") 
    ...
    function mint(address to) external onlyOwner payable {
        ...
        _setTokenURI(tokenId, "ipfs://QmTG3rpe3YvUZTUjb2fp7TrEzL5pF7QJGke8WHZzdfun1k/6/");
        _setTokenRoyalty(tokenId, initialOwnerR, 100);

         musicTracks[tokenId] = MusicTrack("Why me, Why now?", "Aria Harmony");
